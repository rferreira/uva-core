 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.sifinfo.org/infrastructure/1.x}AuthenticationInfo" maxOccurs="unbounded" minOccurs="0"/>
...
public class Authentication {
    ...
    @XmlElement(name = "AuthenticationInfo", required = true)
    protected List<AuthenticationInfo> authenticationInfo;
    ...
    public List<AuthenticationInfo> getAuthenticationInfo() {
        if (authenticationInfo == null) {
            authenticationInfo = new ArrayList<AuthenticationInfo>();
        }
