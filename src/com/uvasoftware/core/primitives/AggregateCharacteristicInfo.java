 ...
 *         &lt;element ref="{http://www.sifinfo.org/infrastructure/1.x}Definition" minOccurs="0"/>
 *         &lt;element ref="{http://www.sifinfo.org/infrastructure/1.x}ElementName" minOccurs="0"/>
...
@XmlRootElement(name = "AggregateCharacteristicInfo")
public class AggregateCharacteristicInfo {
