 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.sifinfo.org/infrastructure/1.x}HROtherId" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "EmployeePersonal")
public class EmployeePersonal {

    @XmlElement(name = "HROtherId", required = true)
    protected List<HROtherId> hrOtherId;
    ...
    /**
     * Gets the value of the hrOtherId property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hrOtherId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHROtherId().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<HROtherId> getHROtherId() {
        if (hrOtherId == null) {
            hrOtherId = new ArrayList<HROtherId>();
        }
        return this.hrOtherId;
    }
