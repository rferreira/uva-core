 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.sifinfo.org/infrastructure/1.x}SIF_Condition" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "SIF_Conditions")
public class SIFConditions {

    @XmlElement(name = "SIF_Condition", required = true)
    protected List<SIFCondition> sifCondition;
     ...
     * 
     */
    public List<SIFCondition> getSIFCondition() {
        if (sifCondition == null) {
            sifCondition = new ArrayList<SIFCondition>();
        }
