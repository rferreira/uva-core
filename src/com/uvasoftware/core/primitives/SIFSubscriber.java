...
@XmlRootElement(name = "SIF_Subscriber")
public class SIFSubscriber {

    @XmlElement(name = "SIF_Object", required = true)
    protected List<SIFSubscriber.SIFObject> sifObject;
     ...
     * {@link SIFSubscriber.SIFObject }
     * 
     * 
     */
    public List<SIFSubscriber.SIFObject> getSIFObject() {
        if (sifObject == null) {
            sifObject = new ArrayList<SIFSubscriber.SIFObject>();
        }
