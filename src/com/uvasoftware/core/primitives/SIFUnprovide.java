...
@XmlRootElement(name = "SIF_Unprovide")
public class SIFUnprovide
    extends SIFMessageType
{

    @XmlElement(name = "SIF_Object", required = true)
    protected List<SIFUnprovide.SIFObject> sifObject;
     ...
     * {@link SIFUnprovide.SIFObject }
     * 
     * 
     */
    public List<SIFUnprovide.SIFObject> getSIFObject() {
        if (sifObject == null) {
            sifObject = new ArrayList<SIFUnprovide.SIFObject>();
        }
